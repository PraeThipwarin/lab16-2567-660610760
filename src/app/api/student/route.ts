...
export const DELETE = async (request: NextRequest) => {
  ...
  if(DB.students[foundIndex] !== null){
    DB.students = DB.students.filter((std) => std.studentId !== DB.students[foundIndex].studentId);
  }
  ...
  return NextResponse.json({
    ok: true,
    message: `Student Id ${DB.students[foundIndex].studentId} has been deleted`,
  });
};
